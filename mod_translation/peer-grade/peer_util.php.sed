'Student image';'Obraz przesłany przez kursanta'
'Student PDF';'PDF przesłany przez kursanta'
Will launch in new window;Otworzy się w nowym oknie
Unable to load key/secret for;Nie można załadować klucza/sekretu dla
View Media;Obejrzyj pliki
Content Item Dialog;Dialog Content Item
No HTML Found;Nie odnaleziono HTML
click to view;kliknij by obejrzeć
No Code Found;Nie odnaleziono kodu
<p>Code:;<p>Kod:
Click on each image/pdf to see a larger view of the image.;Kliknij na każdym obrazie/pdfie aby obejrzeć go w powiększeniu.
<p>Notes:;<p>Notatki:
'From '.$CFG->servicename.', Your Peer Graded Entry Has Been Reset';$CFG->servicename.' - Twoje zgłoszenie oceniane przez innych kursantów zostało zresetowane'
"This is an automated message.  Your peer-graded entry has been reset.$E$E";"To jest automatyczna wiadomość. Twoje zgłoszenie oceniane przez innych kursantów zostało zresetowane.$E$E"
'Course Title:;'Tytuł kursu:
'Assignment:;'Zadanie:
"Notes regarding this action:";"Notatki dotyczące tej akcji:"
