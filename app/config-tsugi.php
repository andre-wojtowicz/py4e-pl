...
$CFG->dbuser    = '___DB_USER___';
$CFG->dbpass    = '___DB_PASS___';
...
$CFG->storehide = true; // A regex like - '/dev/sample|test|beta/';
...
$CFG->context_title = "___CONTEXT_TITLE___";
...
$CFG->servicename = '___SERVICE_NAME___';
...
$CFG->ownername = '___OWNER_NAME___';  // 'Charles Severance'
$CFG->owneremail = '___OWNER_EMAIL___'; // 'csev@example.com'
...
$CFG->google_client_id = '___GOOGLE_CLIENT_ID___';
$CFG->google_client_secret = '___GOOGLE_CLIENT_SECRET___';
...
$CFG->expire_pii_days = ___EXPIRE_PII_DAYS___;  // Three months  (minimum 20)
$CFG->expire_user_days = ___EXPIRE_USER_DAYS___;  // One year (minimum 40)
$CFG->expire_context_days = ___EXPIRE_CONTEXT_DAYS___; // 1.5 Years (minimum 60)
$CFG->expire_tenant_days = ___EXPIRE_TENANT_DAYS___; // Two years (minimum 80)
...
//$CFG->google_map_api_key = 'AIzaSyCAVySwgjLf_hP8COfhRX90g86CoEi_U78';
...
$CFG->cookiesecret = '___COOKIE_SECRET___';
$CFG->cookiename = '___COOKIE_NAME___';
$CFG->cookiepad = '___COOKIE_PAD___';

// Where the bulk mail comes from - should be a real address with a wildcard box you check
$CFG->maildomain = '___MAIL_DOMAIN___'; // 'mail.example.com';
$CFG->mailsecret = '___MAIL_SECRET___';
...
$CFG->sessionsalt = "___SESSION_SALT___";

// Timezone
$CFG->timezone = 'Europe/Warsaw'; // Nice for due dates

// Universal Analytics
$CFG->universal_analytics = "___UNIVERSAL_ANALYTICS___"; // "UA-57880800-1";
